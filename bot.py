...
TOKEN = '7463526503:AAHHSp6Gv7qyOKZEukl4Brxa8O2TrwFp-Rg'
bot = telebot.TeleBot(TOKEN)

# Admin user IDs
admin_id = ["6397654988", "-1002178243149"]

# insert your Telegram username without @
BOT_ADMIN = "AaghaFazal"
...
def handle_ddos(message):
    ...
    keyboard.add(InlineKeyboardButton("𝐏𝐥𝐚𝐧", callback_data="plan"))
    keyboard.add(InlineKeyboardButton("𝐀𝐝𝐦𝐢𝐧", url=f"https://t.me/{BOT_ADMIN}"))
    keyboard.add(InlineKeyboardButton("𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫", url="https://t.me/AaghaFazal"))
    keyboard.add(InlineKeyboardButton("𝐉𝐨𝐢𝐧 𝐆𝐫𝐨𝐮𝐩", url="https://t.me/LGCY_OFFICIAL"))
...
def show_help(message):
    user_id = str(message.chat.id)
    if user_id == proxy_server or user_id == antiban or user_id in admin_id or user_id in allowed_user_ids:
       help_text =''' 
...
'''
       ...
       keyboard = InlineKeyboardMarkup()
       keyboard.add(InlineKeyboardButton("𝐑𝐮𝐥𝐞", callback_data="rules"))
       keyboard.add(InlineKeyboardButton("𝐏𝐥𝐚𝐧", callback_data="plan"))
       keyboard.add(InlineKeyboardButton("𝐆𝐞𝐭 𝙃𝙩𝙩𝙥𝘾𝙖𝙣𝙖𝙧𝙮", url="https://github.com/file-by-lgcyfazal-123456789/Files/releases/download/V1.0.0/HttpCanary.HTTP.Sniffer_Capture_Analysis_3.3.5_APKPure.apk"))
       keyboard.add(InlineKeyboardButton("𝐒𝐭𝐫𝐢𝐤𝐞 𝐇𝐢𝐬𝐭𝐨𝐫𝐲", callback_data="mylogs"))
       keyboard.add(InlineKeyboardButton("𝐀𝐝𝐦𝐢𝐧 𝐂𝐨𝐦𝐦𝐚𝐧𝐝", callback_data="admincmd"))
...
𝗙𝗲𝗲𝗹 𝗙𝗿𝗲𝗲 𝘁𝗼 𝗘𝘅𝗽𝗹𝗼𝗿𝗲... 
        '''
        keyboard = InlineKeyboardMarkup()
        keyboard.add(InlineKeyboardButton("𝐇𝐞𝐥𝐩", callback_data="help"))
        keyboard.add(InlineKeyboardButton("𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫", url="https://t.me/AaghaFazal"))
        keyboard.add(InlineKeyboardButton("𝐀𝐝𝐦𝐢𝐧", url=f"https://t.me/{BOT_ADMIN}"))
        keyboard.add(InlineKeyboardButton("𝐉𝐨𝐢𝐧 𝐆𝐫𝐨𝐮𝐩", url="https://t.me/LGCY_OFFICIAL"))
...
'''
 ...
 # Create an inline keyboard with a button for user
        keyboard = InlineKeyboardMarkup()
        keyboard.add(InlineKeyboardButton("𝐀𝐥𝐥 𝐔𝐬𝐞𝐫𝐬", callback_data="allusers"))
        keyboard.add(InlineKeyboardButton("𝐔𝐬𝐞𝐫 𝐇𝐢𝐬𝐭𝐨𝐫𝐲", callback_data="logs"))
        keyboard.add(InlineKeyboardButton("𝐂𝐥𝐞𝐚𝐫 𝐔𝐬𝐞𝐫 𝐇𝐢𝐬𝐭𝐨𝐫𝐲", callback_data="clearlogs"))
...
def handle_callback_query(call):
    if call.data == "help":
       ...
       welcome_plan(call.message)   
    elif call.data == "rules":
       welcome_rules(call.message)
    elif call.data == "mylogs":
        show_command_logs(call.message)
    elif call.data == "admincmd":
        welcome_admincmd(call.message)  
    elif call.data == "allusers":
        show_all_users(call.message)
    elif call.data == "logs":
       show_recent_logs(call.message)
    elif call.data == "clearlogs":
        clear_logs_command(call.message)
